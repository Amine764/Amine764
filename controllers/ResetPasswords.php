...
class ResetPasswords{
    ...
    public function __construct(){
       ...
       $this->mail->Port = 2525;
       $this->mail->Username = '6ca4905985765f';
       $this->mail->Password = '746a7365307e3e';
    }
    ...
    public function sendEmail(){
        ...
        $url = 'http://localhost/User-system/create-new-password.php?selector='.$selector.'&validator='.bin2hex($token);
